...
public class DateUtils {
    ...
    public static Date handlePointTime(String dateTimeStr){
        // 日期时间字符串
//        String dateTimeStr = "2024-11-07 00:00:00.0";
    ...
    public static void main(String[] args) {
        Date s = handlePointTime("2024-11-07 00:00:00.0");
        String format = DateUtils.format(s, DATE_TIME_PATTERN);
