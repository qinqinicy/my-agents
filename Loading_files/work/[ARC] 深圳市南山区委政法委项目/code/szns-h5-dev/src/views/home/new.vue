  ...
  <div class="home-wrapper van-safe-area-bottom relative">
    ...
    <div class="home-content">
      ...
      >
        ...
        <!-- 辖区动态 -->
        <div class="group_1 flex flex-col p-[12px] pb-[24px] mb-[12px]">
          <div class="block_1 flex justify-between">
            <div class="img-t_1 flex flex-row content-center">
              <!-- <img
            class="thumbnail_4 mt-[4px]"
            referrerpolicy="no-referrer"
            src="~@/assets/images/home_6.png"
          /> -->
              <span class="text-group_1">辖区动态</span>
            </div>
            <div class="group_3 pl-[11px] pr-[19px] relative">
              <!-- @click="handleAreClick" -->
              {{ showAreaTemp.departmentName }}
            </div>
          </div>
          <div class="list_1 flex-col mt-[12px]">
            <!-- 事件 -->
            <div class="image-text_4 flex-col py-[8px]">
              <div
                class="title-box flex justify-between content-center mb-[10px]"
              >
                <span class="text-group_5">事件</span>
                <span class="text-group_6">
                  数据更新时间：{{ updateTime }}
                </span>
              </div>
              <div class="block_2 flex flex-row px-[12px] pt-[9px] pb-[6px]">
                <!-- 左 -->
                <div
                  class="block_3 flex flex-col"
                  @click="handleTotalEventClick()"
                >
                  <span class="text-group_7 mb-[2px]">今日事件总量</span>
                  <div class="flex flex-nowrap items-end">
                    <span class="text-group_8">{{
                      todayEventObject.todayEventTotal
                    }}</span
                    ><span class="text-group_9">件</span>
                  </div>
                </div>
                <!-- 右 -->
                <div class="block_4 flex justify-between flex-1 pl-[28px]">
                  <div
                    class="block_5 flex flex-col"
                    @click="handleTotalEventClick(0)"
                  >
                    <span>维稳事件</span>
                    <div class="flex flex-nowrap items-end">
                  ...
                  <div
                    ...
                    @click="handleTotalEventClick(1)"
                  >
                    <span>重点事件</span>
                    <div class="flex flex-nowrap items-end">
                      <span class="text-group_10">{{
                        todayEventObject.todayKeyEventTotal
                      }}</span
                      ><span class="text-group_9">件</span>
                    </div>
                  </div>
            ...
            <div class="image-text_4 flex-col py-[8px]">
              <div
                class="title-box flex justify-between content-center mb-[10px]"
              >
                <span class="text-group_5">人口</span>
              </div>
              <div class="block_2 flex flex-row px-[12px] pt-[9px] pb-[6px]">
                <!-- 左 -->
                <div
                  class="block_3 flex flex-col"
                  @click="handleTotalPopulationClick"
                >
                  <span class="text-group_7 mb-[2px]">人口总量</span>
                  <div class="flex flex-nowrap items-end">
                    <span class="text-group_8">{{ userNumObject.total }}</span
                    ><span class="text-group_9">人</span>
                  </div>
                </div>
                <!-- 右 -->
                <div class="block_4 flex justify-between flex-1 pl-[24px]">
                  <div class="flex flex-col">
                    <span>今日人口核采</span>
                    <div class="flex flex-nowrap items-end">
                      <span class="text-group_10">{{
                        userNumObject.todayCaiHe
                      }}</span
                      ><span class="text-group_9">人</span>
                    </div>
                  </div>
            ...
            <div class="image-text_4 flex-col py-[8px]">
              <div
                class="title-box flex justify-between content-center mb-[10px]"
              >
                <span class="text-group_5">重点人</span>
              </div>
              <div
                class="block_2 flex flex-row items-center justify-items-center px-[12px] pt-[9px] pb-[6px]"
              >
                <!-- 左 -->
                <div class="block_3 flex flex-col">
                  <span class="text-group_7 mb-[2px]">人员总量</span>
                  <div class="flex flex-nowrap items-end">
                    <span class="text-group_8 whitespace-nowrap">{{
                      zdrtj.zdzrs || 0
                    }}</span
                    ><span class="text-group_9">人</span>
                  </div>
                ...
                <!-- 右 -->
                <div
                  class="block_4 flex flex-col justify-between flex-1 pl-[24px]"
                >
                  <!-- 上 -->
                  <div class="flex justify-between mb-[2px]">
                    <div class="flex flex-col">
                      <span>本月重点人走访</span>
                      <div class="flex flex-nowrap items-end">
                        <span class="text-group_10 whitespace-nowrap">{{
                          zdrtj.byzfrs || 0
                        }}</span
                        ><span class="text-group_9">人</span>
                      </div>
                  ...
                  <!-- 下 -->
                  <div class="flex justify-between border-top mt-[2px]">
                    <div class="flex flex-col">
                      <span>总涉事量</span>
                      <div class="flex flex-nowrap items-end">
                        <span class="text-group_10">0</span
                        ><span class="text-group_9">件</span>
                      </div>
                    </div>
                    <div class="flex flex-col">
            ...
            <div class="image-text_4 flex-col py-[8px]">
              <div
                class="title-box flex justify-between content-center mb-[10px]"
              >
                <span class="text-group_5">重点区域</span>
              </div>
              <div class="block_2 flex flex-row px-[12px] pt-[9px] pb-[6px]">
                <!-- 左 -->
                <div class="block_3 flex flex-col">
                  <span class="text-group_7 mb-[2px]">重点区域总量</span>
                  <div class="flex flex-nowrap items-end">
                    <span class="text-group_8">0</span
                    ><span class="text-group_9">个</span>
                  </div>
                </div>
                <!-- 右 -->
                <div class="block_4 flex justify-between flex-1 pl-[24px]">
